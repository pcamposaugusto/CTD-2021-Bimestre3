...
public class Main {
    ...
    private static final String SQL_INSERT1 = "INSERT INTO ANIMAIS (ID,NOME, TIPO) VALUES (1,'Pancho', 'Cachorro')";
    private static final String SQL_INSERT2 = "INSERT INTO ANIMAIS (ID,NOME, TIPO) VALUES (2,'Margô', 'Gato')";
    private static final String SQL_INSERT3 = "INSERT INTO ANIMAIS (ID,NOME, TIPO) VALUES (3,'Madona', 'Elefante')";
    private static final String SQL_INSERT4 = "INSERT INTO ANIMAIS (ID,NOME, TIPO) VALUES (4,'Ventania', 'Cavalo')";
    private static final String SQL_INSERT5 = "INSERT INTO ANIMAIS (ID,NOME, TIPO) VALUES (5,'Lupi', 'Cachorro')";
