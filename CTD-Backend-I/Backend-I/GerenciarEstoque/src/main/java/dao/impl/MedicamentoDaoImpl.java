...
public class MedicamentoDaoImpl implements IDao<Medicamento> {
    ...
    public Medicamento salvar(Medicamento medicamento) {
        ...
        String query = String.format("INSERT INTO medicamentos(codigoNumerico,nome,laboratorio,quantidade,preco) VALUES('%s','%s','%s','%s','%s')", medicamento.getCodigoNumerico(), medicamento.getNome(),medicamento.getLaboratorio(),medicamento.getQuantidade(),medicamento.getPreco());
