public class Main {
    public static void main(String[] args) {
        ...
        Documento doc1 = new Documento("Ata da sessão de Direitos das Minorias", 1);
        Documento doc2 = new Documento("Carta do presidente da França", 3);
        Documento doc3 = new Documento("Carta dos reitores(as) das Universidades Federais", 2);

        MembroDoGoverno handlerBase = new Deputado().setMembroSeguinte(new Ministro().setMembroSeguinte(new Presidente()));

        handlerBase.leituraDoDocumento(doc1);
        handlerBase.leituraDoDocumento(doc2);
        handlerBase.leituraDoDocumento(doc3);
